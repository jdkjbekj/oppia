...
Oppia is an online learning tool that enables anyone to easily create and sare interactive activities (called 'explorations'). These activities simulate a oe-on-one conversation with a tutor, enabling students to learn by doing while getting feedback.
